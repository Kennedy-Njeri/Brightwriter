"""
Django settings for writting project.
...
SECRET_KEY = 'd_2b^138p+)n8+y@gy9%x$7n#vk(l_7t89zwn0%na5fc3)c!%2'
...
WSGI_APPLICATION = 'writting.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'writting_orders/static')
]
